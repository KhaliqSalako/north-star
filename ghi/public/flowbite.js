  ...
  return (function () {
    ...
    var t = {
        ...
        853: function (t, e, i) {
              ...
              if (!e.modifiersData[d]._skip) {
                for (
                  var u = i.mainAxis,
                    ...
                    T = [x].concat(k).reduce(function (t, i) {
                      return t.concat(
                        I(i) === a
                          ? (function (t, e) {
                              void 0 === e && (e = {});
              ...
              if (k) {
                if (d) {
                  var H,
                    ...
                    nt = J(0, T[z], Z[z]),
                    ot = L
                      ? T[z] / 2 - U - nt - et - C.mainAxis
                      : X - nt - et - C.mainAxis,
                    rt = L
                      ? -T[z] / 2 + U + nt + it + C.mainAxis
                      : K + nt + it + C.mainAxis,
                    ...
                    lt = R + rt - ct,
                    dt = J(y ? M(F, R + ot - ct - at) : F, R, y ? D(N, lt) : N);
                  (k[x] = dt), (q[x] = dt - R);
                }
                if (p) {
                  var ut,
                    ...
                    mt = ht - w[ft],
                    _t = -1 !== [n, s].indexOf(E),
                    bt = null != (ut = null == S ? void 0 : S[A]) ? ut : 0,
          ...
          var Ct = Pt(),
            St = Pt({ defaultModifiers: [ot, Lt, it, S, Ot, _t, xt, Z, Et] }),
